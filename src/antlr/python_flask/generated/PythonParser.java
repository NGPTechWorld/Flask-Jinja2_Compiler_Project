...
public class PythonParser extends Parser {
	...
	public static final int
		...
		FALSE=9, NULL=10, IF=11, ELIF=12, ELSE=13, FOR=14, IN=15, RANGE=16, CONTINUE=17, 
		BREAK=18, LKB=19, RKB=20, LSB=21, RSB=22, LPAREN=23, RPAREN=24, COLON=25, 
		COMMA=26, SEMI=27, IDENTIFIER=28, EQUAL=29, PLUS=30, MINUS=31, STAR=32, 
		DIV=33, PLUS_EQUAL=34, MINUS_EQUAL=35, STAR_EQUAL=36, DIV_EQUAL=37, EQ=38, 
		NEQ=39, LT=40, LTE=41, GT=42, GTE=43, COMMENT=44;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'null'", "'if'", "'elif'", "'else'", "'for'", "'in'", "'range'", "'continue'", 
			"'break'", "'{'", "'}'", "'['", "']'", "'('", "')'", "':'", "','", "';'", 
			null, "'='", "'+'", "'-'", "'*'", "'/'", "'+='", "'-='", "'*='", "'/='", 
			"'=='", "'!='", "'<'", "'<='", "'>'", "'>='"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"COLON", "COMMA", "SEMI", "IDENTIFIER", "EQUAL", "PLUS", "MINUS", "STAR", 
			"DIV", "PLUS_EQUAL", "MINUS_EQUAL", "STAR_EQUAL", "DIV_EQUAL", "EQ", 
			"NEQ", "LT", "LTE", "GT", "GTE", "COMMENT"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 268453890L) != 0)) {
				{
				{
				setState(46);
				statement();
	...
	public final CallExpressionContext callExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 271057056L) != 0)) {
				{
				setState(73);
				expression(0);
				setState(78);
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2623456L) != 0)) {
				{
				setState(155);
				value();
				setState(160);
