...
public class PythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"GLOBAL", "IS", "AND", "OR", "NOT", "PASS", "CLASS", "WHILE", "ESC", 
			"EXP", "LKB", "RKB", "LSB", "RSB", "LPAREN", "RPAREN", "COLON", "COMMA", 
			"ARROW", "POWER", "AT", "DOT", "INT", "DOUBLE", "STRING", "TRUE", "FALSE", 
			"NULL", "FSTRING", "IDENTIFIER", "EQUAL", "PLUS", "MINUS", "STAR", "DIV", 
			"MOD", "PLUS_EQUAL", "MINUS_EQUAL", "STAR_EQUAL", "DIV_EQUAL", "MOD_EQUAL", 
